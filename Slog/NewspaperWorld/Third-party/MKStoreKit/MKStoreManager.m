...
@property (nonatomic, assign)   int         currentBookID;
            ...
            forReceipt:(NSData*) receiptData
{
    ...
    {
        if(NWApiClientBaseURL && SERVER_PRODUCT_MODEL)
        {
            ...
            thisProduct.bookID = self.currentBookID;
            thisProduct.token  = self.currentToken;
