...
// Returns the start focused frame for this media view. This frame is usually a full screen frame.
...
// Returns showinf state for focus window
@property (nonatomic, readonly) BOOL isShowing;
// Returns whether close button is visible. Defaults to NO.
@property (nonatomic, assign) BOOL isCloseButtonVisible;
// Returns title for close button
